...
Rails.application.configure do
  ...
  config.asset_host = SITE_PRODUCTION_URL
  ...
  # config.active_job.queue_name_prefix = "tree_recycle_production"
  ...
  config.action_mailer.default_url_options = { host: MAILER_PRODUCTION_DEFAULT_URL_HOST }
