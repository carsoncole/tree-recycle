class CreateSettings < ActiveRecord::Migration[7.0]
  def up
    ...
    Setting.create  site_title:  'Tree Recycle',
                    site_description: 'Our Tree Recycle event is to fundraise that will support our program.',
                    ...
                    pickup_date_and_time: Time.now + 6.months,
